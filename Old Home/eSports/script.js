document.addEventListener('DOMContentLoaded', function() {
    const footballPlayers = [
        ...
        { name: 'SUVO', image: 'SUVO2.jpg', stats: { Wins: 85, Losses: 15, Goals: 70, Assists: 90, Appearances: 45 } }
        // Add more players as needed
    ];

    const freeFirePlayers = [
        { name: 'RAKIB', image: 'RAKIB1.jpg', stats: { Wins: 100, Losses: 50, Damage: 2500, TotalKills: 150, Appearances: 70 } },
        { name: 'SABBIR', image: 'SABBIR2.jpg', stats: { Wins: 90, Losses: 30, Damage: 3000, TotalKills: 200, Appearances: 65 } }
        // Add more players as needed
    ];
