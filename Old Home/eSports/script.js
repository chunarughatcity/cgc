document.addEventListener('DOMContentLoaded', function() {
    const footballPlayers = [
        { name: 'Affan Abu Osman', image: 'Affan Abu Osman.jpg', stats: { Wins: 95, Losses: 20, Goals: 60, Assists: 80, Appearances: 50 } },
        { name: 'Thanvir Ahmed Suvo', image: 'Thanvir Ahmed Suvo.jpg', stats: { Wins: 85, Losses: 15, Goals: 70, Assists: 90, Appearances: 45 } },
        { name: 'ATIKUR SAKIB', image: 'ATIKUR SAKIB.jpg', stats: { Wins: 85, Losses: 15, Goals: 70, Assists: 90, Appearances: 45 } },
        { name: 'Mir Sah Zisan', image: 'Mir Sah Zisan.jpg', stats: { Wins: 85, Losses: 15, Goals: 70, Assists: 90, Appearances: 45 } },
        // Add more players as needed
    ];

    const freeFirePlayers = [
        { name: 'Jubair Sabbir', image: 'Jubair Sabbir.jpg', stats: { Wins: 90, Losses: 30, Damage: 3000, TotalKills: 200, Appearances: 65 } },
        { name: 'Ahmed Bappy', image: 'Ahmed Bappy.jpg', stats: { Wins: 90, Losses: 30, Damage: 3000, TotalKills: 200, Appearances: 65 } },
        { name: 'Jiaur Rohman Sumon', image: 'Jiaur Rohman Sumon.jpg', stats: { Wins: 90, Losses: 30, Damage: 3000, TotalKills: 200, Appearances: 65 } },
        { name: 'Hafijur Rahman Jakaria', image: 'Ahmed Bappy.jpg', stats: { Wins: 90, Losses: 30, Damage: 3000, TotalKills: 200, Appearances: 65 } },
        { name: 'Tanvir Husen Rakib', image: 'Tanvir Husen Rakib.jpg', stats: { Wins: 100, Losses: 50, Damage: 2500, TotalKills: 150, Appearances: 70 } },
        // Add more players as needed
    ];
